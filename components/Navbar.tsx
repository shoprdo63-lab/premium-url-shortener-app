...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 py-8 px-10 backdrop-blur-md bg-[#020806]/40 border-b border-white/5 shadow-[0_4px_30px_rgba(0,0,0,0.1)] transition-all duration-300 hover:bg-[#020806]/60">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-4 group cursor-pointer">
          <div className="relative">
            ...
            {/* Logo Icon */}
            <div className="relative bg-gradient-to-br from-[#064e3b] to-[#022c22] w-12 h-12 rounded-2xl flex items-center justify-center shadow-2xl border border-emerald-500/20 transform group-hover:rotate-6 group-hover:scale-110 transition-all duration-300">
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-black tracking-tight text-white uppercase leading-none group-hover:text-emerald-50 transition-colors">
              The <span className="text-emerald-500 italic drop-shadow-[0_0_15px_rgba(16,185,129,0.4)]">LinkVibe</span>
            </span>
            <div className="h-[2px] w-0 group-hover:w-full bg-emerald-500/50 transition-all duration-700 mt-1 shadow-[0_0_10px_rgba(16,185,129,0.5)]"></div>
          </div>
        </div>
